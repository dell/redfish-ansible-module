...
def main():
    ...
    idracuser = {'UserName': 'user3'}
    idracpswd = {'Password': 'calvin'}
    idracrole = {'RoleId': 'Operator'}
    headers = {'content-type': 'application/json'}

    # Add user
    for payload in idracuser,idracpswd,idracrole:
        add_user(idrac, base_uri, rf_uri, json.dumps(payload), headers)
